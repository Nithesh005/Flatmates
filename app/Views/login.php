            ...
            <div class="col-lg-2 col-md-4 col-sm-12">
                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true"><i class="fa-solid fa-chess-king fa-2x"></i></button>
                    </li>
                    <li class="nav-item" role="presentation">
                ...
                <div class="tab-content content" id="pills-tabContent">
                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                        <div class="jumbotron border border-2 border border-info rounded rounded-o shadow shadow-md">
                            ...
                            <div class="m-3">
                                <div class="form-outline mb-4 input-container">
                                    <input type="password" id="owner_pasword" name="reg_no" class="input" placeholder=" " onblur="passwordValidate1()" />
                            ...
                            <div class="m-3">
                                <input type="submit" value="Login" class="btn btn-lg border-2 border border-info  rounded text-info" style="width:100%;" id="owner_log_btn">
                            </div>
                        </div>
                    </div>
                    <!-- tenat login -->
                    <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                        <div class="jumbotron border border-2 border border-info rounded rounded-o shadow shadow-md">
                            ...
                            <div class="m-3">
                                <div class="form-outline mb-4 input-container">
                                    <input type="text" id="tenant_mail" name="reg_no" class="input" placeholder=" " onblur="Alphanumeric1()" />
                            ...
                            <div class="m-3">
                                ...
                                <div class="m-3">
                                    <input type="submit" value="Login" class="btn btn-lg border-2 border border-info  rounded text-info" style="width:100%;" id="tanet_log_btn">
                                </div>
                            </div>
                        </div>
                    </div>
