            ...
            <div class="col-lg-6 col-md-8">
                <div class="tab-content content" id="pills-tabContent">
                        ...
                        <div class="jumbotron border border-2 border border-info rounded rounded-o shadow shadow-md">
                            ...
                            <div class="m-3">
                                <div class="form-outline mb-4 input-container">
                                    <input type="text" name="reg_no" class="input" placeholder=" " id="reg_no"
                                        onblur="Alphanumeric()" />
                            ...
                            <div class="m-3">
                                <div class="form-outline mb-4 input-container">
                                    <input type="password" id="adminpasword" name="reg_no" class="input" placeholder=" "
                            ...
                            <div class="m-3">
                                <input type="submit" value="Login"
                                    ...
                                    style="width:100%;" id="intern_log_btn">
                            </div>
                        </div>
                    </div>
                    <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                        <div class="jumbotron border border-2 border border-info rounded rounded-o shadow shadow-md">
                            <br>
                            <h2 class="text-center text-success ">Tenat Login</h2>
                            <br>
                            <div class="m-3">
                                <div class="form-outline mb-4 input-container">
                                    <input type="text" id="tenat_id" name="reg_no" class="input" placeholder=" "
                                        onblur="Alphanumeric1()" />
                                    <label for="adminId" class="placeholder label">Email Address</label>
                            ...
                            <div class="m-3">
                                <div class="form-outline mb-4 input-container">
                                    <input type="text" id="tenat_pasword" name="reg_no" class="input" placeholder=" "
                                ...
                                <div class="m-3">
                                    <input type="submit" value="Login"
                                        class="btn btn-lg border-2 border border-info  rounded text-info"
                                        style="width:100%;" id="admin_log_btn">
                                </div>
                            </div>
                        </div>
                    </div>
