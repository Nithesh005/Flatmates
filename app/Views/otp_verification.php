                            ...
                            <div class="jumbotron border border-2 border border-info rounded rounded-o shadow shadow-md">
                                ...
                                <div class="m-3">
                                    <div class="form-outline mb-4 input-container">
                                        ...
                                        <label for="reg_no" class="placeholder label">Enter OTP</label>
                                ...
                                <div class="row m-3">
                                        <div class="col-12" style="display:flex;flex-direction:row-reverse;"><a href="<?php echo base_url('./public/index.php/function/hai') ?>">Send OTP</a></div>
                                </div>
