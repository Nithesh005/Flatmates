                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <div class="jumbotron border border-2 border-info shadow shadow-sm  rounded ">
                                    ...
                                    <div class="m-3">
                                        <div class="form-outline mb-4 input-container">
                                            <input type="text" id="sname" name="sname" class="input" placeholder=" "
                                    ...
                                    <div class="m-3">
                                        <div class="form-outline mb-4 input-container">
                                            <input type="email" id="email_id" name="email_id" class="input"
                                                placeholder=" " onblur="validateEmail()" />
                                    ...
                                    <div class="m-3">
                                        <div class="form-outline mb-4 input-container">
                                            <input type="password" id="password_id" name="password_id" class="input"
                                                placeholder=" " onblur="validatepassword()" />
                                    ...
                                    <div class="m-3">
                                        <div class="form-outline mb-4 input-container ">
                                            <input type="text" id="occupation_id" name="occupation_id" class="input"
                                                placeholder=" " onblur="validateoccupation()" />
                                    ...
                                    <div class="m-3">
                                        <div class="form-outline mb-4 input-container">
                                            <input type="text" id="house_id" name="house_id" class="input"
                                                placeholder=" " onblur="validatehouseno()" />
                                            <label for="house_idt" class="placeholder label">Number of house</label>
                                            <span id="house_err"></span>
                                        </div>
                                    </div>

                                    <div class="m-3">
                                        <div class="form-outline mb-4 input-container ">
                                            <input type="text" id="address_id" name="address_id" class="input"
                                                placeholder=" " onblur="validateaddress()" />
                                    ...
                                    <div class="m-3">
                                        <div class="form-outline mb-4 input-container ">
                                            <input type="text" id="city_id" name="city_id" class="input" placeholder=" "
                                                onblur="validatecity()" />
                                    ...
                                    <div class="m-3">
                                        <div class="form-outline mb-4 input-container ">
                                            <input type="text" id="state_id" name="state_id" class="input"
                                                placeholder=" " onblur="validatestate()" />
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-4">
                                            <button type="button"
                                                ...
                                                style="width:100%" id="reg_first_btn">Next</button>
                                        </div>
                                        <div class="col-4"></div>
                                    </div>
                                </div>
                            ...
                            <div class="carousel-item">
                                <div class="jumbotron border border-2 border-info shadow shadow-sm  rounded ">
                                    ...
                                    <div class="m-3">
                                        <div class="form-outline mb-4 input-container">
                                            <input type="text" name="profile_file_txt" id="profile_file_txt"
                                                class="input" placeholder=" " readonly>
                                            <label for="form2Example11" class="placeholder label">Photo</label>
                                            <div class="pin" id="pin_profile"><i
                                                    class="fa-solid fa-paperclip pin-icon"></i></div>
                                            <input type="file" accept="image/jpeg" name="profile_file" id="profile_file"
                                    ...
                                    <div class="m-3">
                                        ...
                                        <div class="form-outline mb-4 input-container">
                                            <input type="text" name="resume_file_txt" id="resume_file_txt" class="input"
                                                placeholder=" " readonly>
                                            <label for="form2Example11" class="placeholder label">House Document</label>
                                            <div class="pin" id="pin_resume"><i
                                                    class="fa-solid fa-paperclip pin-icon"></i></div>
                                            <input type="file" name="resume_file" id="resume_file"
                                                class="hidden form-control form-control-md">
                                            <span class="label_txt">House document Lesser then 20KB and its only pdf ,
                                                jpg, jpeg
                                                aceept</span>
                                        </div>
                                        <br>
                                    ...
                                    <div class="m-3">
                                        ...
                                        <div class="form-outline mb-4 input-container">
                                            <input type="text" name="bonafide_file_txt" id="bonafide_file_txt"
                                                class="input" placeholder=" " readonly>
                                            <label for="form2Example11" class="placeholder label">Aadhar card </label>
                                            <div class="pin" id="pin_bonafide"><i
                                                    class="fa-solid fa-paperclip pin-icon"></i></div>
                                            <input type="file" name="bonafide_check_file" id="bonafide_check_file"
                                                class="hidden form-control form-control-md">
                            ...
                            <div class="carousel-item">
                                <div class="jumbotron border border-2 border-info shadow shadow-sm  rounded ">
                                    ...
                                    <div class="m-3">
                                        <div class="form-outline mb-4 input-container">
                                            <input type="text" id="aadhar_id" name="aadhar_id" class="input"
                                                placeholder=" " onblur="validateaadhar()" />
