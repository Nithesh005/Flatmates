...
<body>
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <div class="jumbotron border border-2 border-info shadow shadow-sm  rounded ">
                                    ...
                                    <!-- <div class="m-3">
                                        <div class="form-outline mb-4 input-container">
                                            <input type="text" id="house_id" name="house_id" class="input" placeholder=" " onblur="validatehouseno()" />
                                ...
                                <div class="jumbotron border border-2 border-info shadow shadow-sm  rounded ">
                                    ...
                                    <div class="m-3">
                                        ...
                                        <div class="form-outline mb-4 input-container">
                                            ...
                                            <input type="file" accept="image/jpeg" name="resume_file" id="resume_file" class="hidden form-control form-control-md">
                                    ...
                                    <div class="m-3">
                                        ...
                                        <div class="form-outline mb-4 input-container">
                                            ...
                                            <input type="file" accept="image/jpeg" name="bonafide_check_file" id="bonafide_check_file" class="hidden form-control form-control-md">
    ...
    <script>
        ...
        $('#reg_third_bt').click(function() {
            ...
            var smart_card = $('#resume_file').val();
