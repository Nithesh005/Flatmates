            ...
            <div class="jumbotron border border-2 border border-info rounded rounded-o shadow shadow-md">
              ...
              <div class="m-3">
                <div class="form-outline mb-4 input-container">
                  <input type="text" name="reg_no" class="input" placeholder=" " id="owner_mail"
                    onblur="Alphanumeric()" />
                  <label for="reg_no" class="placeholder label">new Password</label>
                ...
                <div class="form-outline mb-4 input-container">
                  <input type="text" name="reg_no" class="input" placeholder=" " id="owner_mail"
                    onblur="Alphanumeric()" />
                  <label for="reg_no" class="placeholder label">Re-enter the Password</label>
                  <span id="email_otp"></span>
                </div>
              ...
              <div class="m-3">
                <input type="submit" value="Next" class="btn btn-lg border-2 border border-info  rounded text-info"
                  style="width:100%;" id="owner_log_btn" onclick="loger()">
              </div>
            </div>
          </div>
        </div>
...
<script>
    function loger() {
        location.replace("<?php echo base_url('./public/index.php/home/login') ?>");
    }
</script>