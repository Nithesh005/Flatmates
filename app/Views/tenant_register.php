                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <div class="jumbotron border border-2 border-info shadow shadow-sm  rounded ">
                                ...
                                <div class="m-3">
                                    <div class="form-outline mb-4 input-container ">
                                        <input type="text" id="state_id" name="state_id" class="input" placeholder=" "
                        ...
                        <div class="carousel-item">
                            <div class="jumbotron border border-2 border-info shadow shadow-sm  rounded ">
                                ...
                                <div class="m-3">
                                    <div class="form-outline mb-4 input-container">
                                        <input type="text" name="profile_file_txt" id="profile_file_txt" class="input"
                                            placeholder=" " readonly>
                                        <label for="form2Example11" class="placeholder label">Photo</label>
                                        <div class="pin" id="pin_profile"><i class="fa-solid fa-paperclip pin-icon"></i>
                                        </div>
                                ...
                                <div class="m-3">
                                    ...
                                    <div class="form-outline mb-4 input-container">
                                        ...
                                        <div class="pin" id="pin_resume"><i class="fa-solid fa-paperclip pin-icon"></i>
                                        </div>
                                ...
                                <div class="m-3">
                                    ...
                                    <div class="form-outline mb-4 input-container">
                                        <input type="text" name="bonafide_file_txt" id="bonafide_file_txt" class="input"
                                            placeholder=" " readonly>
                        ...
                        <div class="carousel-item">
                            <div class="jumbotron border border-2 border-info shadow shadow-sm  rounded ">
                                ...
                                <div class="m-3">
                                    <div class="form-outline mb-4 input-container">
                                        <input type="text" id="aadhar_id" name="aadhar_id" class="input" placeholder=" "
