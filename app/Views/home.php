...
<body>
    ...
    <img src="<?php echo base_url(); ?>/assets/assets_img/rooms3.2.jpg" style=" width: 100%;">
            ...
            <div class=" container-xxl py-5" id="content">
                            <div class="container1">
                                <div class="row g-5 align-items-center">
                                    ...
                                    <div class="col-lg-6">
                                        <h1 class="mb-4"><span class="text-primary text-uppercase">Benefits</span> of
                                            our co-living</h1>
                                ...
                                <div class="row g-4">
                                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                                        <a class="service-item rounded" href="">
                                            ...
                                            <p class="text-body mb-0">Rooms and apartments are for rent at budget
                                                friendly cost.</p>
                                        </a>
                                    </div>
                                            ...
                                            <div class="container pb-5">
                                                <div class="row g-5">
                                                    <div class="container-fo0t">
                                                        ...
                                                        <a class="btn btn-link" href="<?php echo base_url('./public/index.php/home/contact_us') ?>">Contact Us</a>
                                    ...
                                    <!-- Back to Top -->
                                    <a id="gototop" href="#" class="btn btn-lg btn-primary btn-lg-square back-to-top"><i
