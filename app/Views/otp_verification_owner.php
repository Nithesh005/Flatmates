...
<body>
    ...
    <div class="otp_form">
    <h2>You are Entered as owner</h2>
        <form action="<?php echo base_url('public/index.php/home/verifyOTP_owner'); ?>" method="post">
            <div class="row mb-4">
                    ...
                    <div class="tab-content content" id="pills-tabContent">
                        <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                            <div class="jumbotron border border-2 border border-info rounded rounded-o shadow shadow-md">
                                ...
                                <div class="row m-3">
                                    <div class="col-12" style="display:flex;flex-direction:row-reverse;"><a href="<?php echo base_url('./public/index.php/home/sendEmail_owner') ?>">Send OTP</a></div>
                                </div>
